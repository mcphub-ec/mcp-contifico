...
SPECS = [
    ToolSpec(
        ...
        path='/api/v2/persona/',
        mode='params',
        query=('search', 'modificados_desde_fecha', 'estado', 'fecha_inicial', 'fecha_final', 'es_proveedor', 'es_cliente', 'tipo', 'page', 'categoria_id'),
    ),
    ToolSpec(
    ...
    ToolSpec(
        ...
        path='/api/v2/persona/',
        mode='body',
        required=('tipo', 'razon_social', 'es_cliente', 'es_proveedor', 'cedula', 'es_vendedor', 'es_empleado', 'es_corporativo', 'es_extranjero', 'aplicar_cupo'),
        optional=('ruc', 'nombre_comercial', 'email', 'telefonos', 'direccion', 'placa', 'porcentaje_descuento', 'adicionales_cliente', 'adicionales_proveedor', 'personaasociada_id', 'banco_codigo_id', 'numero_tarjeta', 'tipo_cuenta', 'origen'),
        pos_arg='pos_token',
        pos_in_params=True,
    ),
    ToolSpec(
        ...
        mode='body',
        required=('tipo', 'razon_social', 'es_cliente', 'es_proveedor', 'cedula', 'es_vendedor', 'es_empleado', 'es_corporativo', 'es_extranjero', 'aplicar_cupo'),
        optional=('ruc', 'nombre_comercial', 'email', 'telefonos', 'direccion', 'placa', 'porcentaje_descuento', 'adicionales_cliente', 'adicionales_proveedor', 'personaasociada_id', 'banco_codigo_id', 'numero_tarjeta', 'tipo_cuenta'),
        pos_arg='pos_token',
        pos_in_params=True,
    ),
    ToolSpec(
    ...
    ToolSpec(
        ...
        mode='params',
        query=('modificados_desde_fecha', 'fecha_inicial', 'fecha_final', 'filtro', 'page', 'estado', 'categoria_id'),
    ),
    ToolSpec(
    ...
    ToolSpec(
        ...
        path='/api/v2/producto/',
        mode='body',
        required=('nombre', 'codigo', 'estado', 'pvp1', 'minimo', 'tipo', 'tipo_producto'),
        optional=('codigo_barra', 'codigo_auxiliar', 'categoria_id', 'marca_id', 'porcentaje_iva', 'pvp2', 'pvp3', 'pvp4', 'pvp_manual', 'cuenta_venta_id', 'cuenta_compra_id', 'cuenta_costo_id', 'costo_maximo', 'para_pos', 'personalizado1', 'personalizado2', 'unidad', 'porcentaje_ice', 'valor_ice', 'campo_catalogo', 'maneja_nombremanual', 'porcentaje_servicio'),
    ),
    ToolSpec(
    ...
    ToolSpec(
        ...
        path='/api/v2/movimiento-inventario/',
        mode='inv_create',
        required=('tipo', 'fecha', 'bodega_id', 'descripcion', 'detalles', 'generar_asiento'),
    ...
    ToolSpec(
        ...
        path='/api/v2/documento/',
        mode='body',
        required=('fecha_emision', 'tipo_documento', 'tipo_registro', 'documento', 'autorizacion', 'descripcion', 'referencia', 'subtotal_0', 'subtotal_12', 'iva', 'ice', 'total', 'detalles', 'reserva_relacionada'),
        optional=('cliente', 'persona', 'vendedor', 'cobros', 'estado', 'caja_id', 'servicio', 'adicional1', 'adicional2', 'hora_emision', 'electronico', 'documento_relacionado_id'),
        pos_arg='pos',
    ),
    ToolSpec(
        ...
        mode='body',
        required=('fecha_emision', 'tipo_documento', 'tipo_registro', 'documento', 'autorizacion', 'descripcion', 'referencia', 'subtotal_0', 'subtotal_12', 'iva', 'ice', 'total', 'detalles', 'reserva_relacionada'),
        optional=('cliente', 'persona', 'vendedor', 'estado', 'caja_id', 'servicio', 'adicional1', 'adicional2'),
        pos_arg='pos',
    ),
    ToolSpec(
    ...
    ToolSpec(
        ...
        optional=('tipo_ping', 'fecha', 'numero_cheque', 'cuenta_bancaria_id', 'numero_comprobante', 'lote'),
    ),
    ToolSpec(
